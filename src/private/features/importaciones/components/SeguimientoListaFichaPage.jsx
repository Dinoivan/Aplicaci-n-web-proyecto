...
export function SeguimientoListaFichaPage() {
            ...
            <>
              ...
              <section className="headbar headbar--abierto">
                  ...
                  <div class="headbar__title">
                      <h3>Seguimiento de Fechas y documentación - Lista de Fichas</h3>
                        ...
                        <table class="tabla" cellSpacing="0" cellPadding="0">
                          <thead>
                              <tr>
                                ...
                                <th class="thead">  Agente de carga</th>
                                <th class="thead">Agente de aduana   </th>
                                <th class="thead">Denominación</th>
                                <th class="thead">  Fecha plan  </th>
                                <th class="thead"> Fecha real </th>
                          ...
                          <tbody>
                              ...
                              <tr>
                              <td className="ficha__group">
                                     <a  href="#"><em class="ico-element-ficha"></em> 2101230015</a>
                                </td>
                                  <td><strong>100000</strong></td> 
                                  <td>-</td> 
                                  <td>-</td> 
                              ...
                              <tr>
                              <td className="ficha__group">
                                     <a  href="#"><em class="ico-element-ficha"></em> 2101230045</a>
                                </td>
                                  <td><strong>100000</strong></td> 
                                  <td>-</td> 
                                  <td>-</td> 
                              ...
                              <tr>
                              <td className="ficha__group">
                                     <a  href="#"><em class="ico-element-ficha"></em> 2101230345</a>
                                </td>
                                  <td><strong>100000</strong></td> 
                                  <td>-</td> 
                                  <td>-</td> 
                              ...
                              <tr>
                              <td className="ficha__group">
                                     <a  href="#"><em class="ico-element-ficha"></em> 2101230342</a>
                                </td>
                                  <td><strong>100000</strong></td> 
                                  <td>-</td> 
                                  <td>-</td> 
                              ...
                              <tr>
                              <td className="ficha__group">
                                     <a  href="#"><em class="ico-element-ficha"></em> 2101230255</a>
                                </td>
                                  <td><strong>100000</strong></td> 
                                  <td>-</td> 
                                  <td>-</td> 
